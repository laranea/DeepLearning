...
def train(epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        if batch_idx % 10 == 0:
            ...
            import numpy
            with open('./train_loss_binarized_mlp2.txt', 'a') as lossfile, open('./epochs_binarized_mlp_2.txt', 'a') as epochfile:
...
with open('./test_bin_mlp_2.txt','a') as testfile:
...
filename = './binarized_mlp_2.pickle'
