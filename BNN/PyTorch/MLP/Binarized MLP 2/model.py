...
class MLP_Binarized(torch.nn.Module):
    def __init__(self):
        ...
        self.bn1 = torch.nn.BatchNorm1d(2048*self.infl_ratio)
        self.fc2 = BinarizeLinear(2048*self.infl_ratio, 2048*self.infl_ratio)
        self.ht2 = torch.nn.Hardtanh()
        self.bn2 = torch.nn.BatchNorm1d(2048*self.infl_ratio)
        self.fc3 = BinarizeLinear(2048*self.infl_ratio, 2048*self.infl_ratio)
        self.ht3 = torch.nn.Hardtanh()
        self.bn3 = torch.nn.BatchNorm1d(2048*self.infl_ratio)
        self.fc4 = torch.nn.Linear(2048*self.infl_ratio, 10)
