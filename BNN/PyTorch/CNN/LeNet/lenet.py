...
train_dataset = datasets.MNIST('./../mnist/',download=True,transform=transforms.Compose([transforms.Scale((32, 32)),transforms.ToTensor()]))
test_dataset = datasets.MNIST('./../mnist/',train=False,download=True,transform=transforms.Compose([transforms.Scale((32, 32)),transforms.ToTensor()]))
...
def train(epoch):
    ...
    for batch_idx,(data,target) in enumerate(train_loader):
        ...
        if batch_idx % 10==0:
            ...
            import numpy
            with open('./train_loss_lenet.txt', 'a') as lossfile, open('./epochs_lenet.txt', 'a') as epochfile:
...
for epoch in range(1, 501):
    ...
    with open('./test_lenet.txt','a') as testfile:
