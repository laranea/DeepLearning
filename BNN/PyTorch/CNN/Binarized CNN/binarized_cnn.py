...
def train(epoch):
    ...
    for batch_idx,(data,target) in enumerate(train_loader):
        ...
        if batch_idx % 10==0:
            ...
            import numpy
            with open('./train_loss_cnn_binarized.txt', 'a') as lossfile, open('./epochs_cnn_binarized.txt', 'a') as epochfile:
